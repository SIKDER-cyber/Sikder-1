...
\033[1;32m____ _ _  _ ___  ____ ____ 
\033[1;32m[__  | |_/  |  \ |___ |__/ 
\033[1;32m___] | | \_ |__/ |___ |  \                                                                            
\033[1;99m==============================================================================
\033[1;32m[✓]AUTHOR  :\033[1;32m SIKDER
\033[1;32m[✓]TOOL    :\033[1;32m NEW 
\033[1;32m[✓]FACEBOOK:\033[1;32m SIKDER OBEAYDUL
...
def auto_pass(fileeee):
    ...
    print(cox)
    print("  [✓] Id Save: /sdcard/sikder.txt")
    print(cox)
...
def file_subb(uid,pwx):
    global oks,loop
    sys.stdout.write(f"\r  \033[38;5;46m[sikder] {loop}|{str(len(oks))}");sys.stdout.flush()
